...
cd shouldipickitup
sed -i s'#MONGOCLIENTLINE#client = MongoClient("mongodb+srv://MONGOUSERNAME:MONGOPASSWORD@MONGOHOST/test?retryWrites=true&w=majority", serverSelectionTimeoutMS=2000)#'  lib/mongodb.py
